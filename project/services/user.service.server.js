module.exports = function (app) {
    ...
    var users = [
        {
            ...
            workEx: [{
                ...
                company: 'Microsoft',
                position: 'Principal and Creative Lead',
                duration: '2005-2006',
        ...
        },
        {
            ...
            firstName: "doggy", lastName: "doggy",
            email: "doggy@doggy.com", experience: "0 years",
        ...
        },
        {
            ...
            password: "jun",
            role: "user",
            about: "Ruby Developer",
            firstName: "Jun", lastName: "Yan",
            email: "jun@yan.com", experience: "1 years",
    ...
    function createUser(req, res) {
        ...
        var id = -1;
        user_unique_id += 1;
        id = user_unique_id.toString();
        console.log("UserService:Server createUser User with id" + id);
        newUser._id = id;
        users.push(newUser);
        res.send(newUser);
    }
    ...
    function uploadImage(req, res) {
        ...
        if (req.file) {
            ...
            for (var i in users) {
                if (users[i]._id == userId) {
                    console.log("UserService:Server user found");
                    users[i].imgurl = "/uploads/" + filename;
                }
            }
